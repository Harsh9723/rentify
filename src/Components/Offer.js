          ...
          <div className="row mt-4">
            <div className="col-lg-4">
              <div className="card border-0 mt-5" style={{   backgroundColor: "rgb(207, 204, 204);" }}>
                ...
                <img className="card-img-top" src="images/car1.jpeg" alt="Card image cap" width="100%" />
              </div>
            ...
            <div className="col-lg-4">
              <div className="card border-0 mt-5" style={{   backgroundColor: "grey" }}>
                <div className="card-img bg-white" style={{ width: "100%",height: "250px" }}>
                <img className="card-img-top" src="images/carr2.png" alt="Card image cap" width="100%" />
              </div>
                <div className="card-body p-3  bg-white">
                  <h5 className="card-title">Ferari</h5>
                  <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
